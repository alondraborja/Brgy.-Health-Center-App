...
<html lang="en">
  ...
  <body class="text-center" style="">
    ...
    <header>
      <div class="logo">
        ...
        <div style="margin-top: 5px;">
          <a href="welcome.php">
            <span class="up">Brgy. Health</span><br>
            <span style="margin-left: -7px;">Center App</span>
          </a>
        </div> 
      </div>
    ...
    <div class="container rounded-3" style="margin-top: 5%; margin-bottom: 5%; width: 75%; background-image: linear-gradient(145deg, #23467a , #36a7e3); background-size: 30%; background-repeat: no-repeat; box-shadow: 0 7px 50px 0 rgba(0, 0, 0, 0.29);">
      ...
      <div class="row center-align" >
        ...
        <div class="col-6 col-md-4 rounded-3" style="height: 500px; width: 30%;">
          <img src="assets/logo/temp.png" width="50%" style="margin:80px 0 0 0">
            <p class="py-4" style="text-align: center; color: white;line-height: 1.3; font-size: 15px">Brgy. Health Center App<br>Online Health Consultation Portal</p>
        </div>
      ...
      <ul class="footer-right" style="text-align: left;">
        ...
        <li>
          ...
          <ul class="box">
            ...
            <li><a href="#"><i class="fa fa-envelope"></i>&nbsp;Email: brgyhealthcenterapp@gmail.com</a></li>
          </ul>
        </li>
      </ul>
      <div class="footer-bottom">
        <p>All rights reserved by &copy; Brgy. Health Center App 2021</p>
      </div>
    </footer>
  </body>
