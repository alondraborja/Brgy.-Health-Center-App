...
<html lang="en">
  ...
  <body>
    <header>
      ...
      <div class="form-container container rounded-3 g-5" style="margin-top: 5%; margin-bottom: 5%; width: 75%; box-shadow: 0 7px 50px 0 rgba(0, 0, 0, 0.29); ">
          ...
          <div class="row container-fluid py-4">
              ...
              <form action="includes/register_patient.inc.php" method="post">
                  ...
                  <div class="row g-3 main-form">

                      <div class="col-sm-4 user-inputs">
